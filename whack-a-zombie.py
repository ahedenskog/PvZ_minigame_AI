...
while True:
    ...
    ZombieToo = pyautogui.locateOnScreen("C:/Users/albin.hedenskog/Documents/GitHub/PvZ_minigame_AI/assets/zombieToo.png", confidence=0.6)
    ...
    if ZombieToo != None:
        print("I see a zombie at:", Zombie, ZombieToo)
    else:
